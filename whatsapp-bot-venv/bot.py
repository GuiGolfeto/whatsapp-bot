...
def bot():
    ...
    msg = resp.message()
    responded = False
    if 'citação' in incoming_msg or 'frase' in incoming_msg: 
    ...
    if 'dog' in incoming_msg or 'cachorro' in incoming_msg:
        # retorne uma foto de cachorro
        msg.media('https://place.dog/300/200')
        responded = True
